...
{
   private final Color[] colorValues = {Color.BLACK, Color.BLUE, Color.RED, Color.GREEN, Color.YELLOW, Color.MAGENTA};   
   ...
   public MenuFrame()
   {
      ...
      String[] colors = {"Black", "Blue", "Red", "Green", "Yellow", "Magenta"};
